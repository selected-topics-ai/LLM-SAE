...
SYSTEM_PROMPT = ("You score texts generated by a language model based on the following criterion:\n{criterion}.\n"
                 ...
                 "Evaluate the text based on the criterion. Output format should be JSON with format:\n")
...
def behavioral_system_prompt(text: str) -> str:
    behavioral_criterion = BEHAVIORAL_CRITERION.format(text)
    return SYSTEM_PROMPT.format(criterion=behavioral_criterion) + "```json\n{\n \"score\": <int>\n}\n```\n"

def coherence_system_prompt() -> str:
    return SYSTEM_PROMPT.format(criterion=COHERENCE_CRITERION) + "```json\n{\n \"score\": <int>\n}\n```\n"
